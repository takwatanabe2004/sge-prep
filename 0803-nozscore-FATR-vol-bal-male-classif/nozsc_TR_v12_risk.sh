#! /bin/bash
#
# This script has been created to run the ./nozsc_TR_v12_risk.mcc 
...
#$ -o /cbica/home/watanabt/sge_job_output/nozsc_TR_v12_risk.mcc.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/watanabt/sge_job_output/nozsc_TR_v12_risk.mcc.$JOB_ID.stderr
####
#### My email address:
...
# file /cbica/home/watanabt/sge_job_output/nozsc_TR_v12_risk.mcc.$JOB_ID.stdout) and standard error (saved
# into the file /cbica/home/watanabt/sge_job_output/nozsc_TR_v12_risk.mcc.$JOB_ID.stderr) to make
# it easier to diagnose queued commands

/bin/echo "Command: ./nozsc_TR_v12_risk.mcc"
/bin/echo "Arguments: "
/bin/echo -e "Executing in: \c"; pwd
/bin/echo -e "Executing on: \c"; hostname
/bin/echo -e "Executing at: \c"; date
/bin/echo "----- STDOUT from ./nozsc_TR_v12_risk.mcc below this line -----"

/bin/echo "Command: ./nozsc_TR_v12_risk.mcc" 1>&2
...
/bin/echo "----- STDERR from ./nozsc_TR_v12_risk.mcc below this line -----" 1>&2

./nozsc_TR_v12_risk.mcc 
