%% tw_0731_balanced_maleOnly_LOO_VOLdiff_nozscore_template.m
%==============================================================================%
...
outname=['nozscore_VOL_',diffusionType,'diff_BAL_male_LOO_',...
         group1,'_vs_',group2,'_',time2,time1];
...
% remove "female" class
mask_male = fmask(meta_info_diff.gender, 'male');
mask.group1 = fmask(meta_info_diff.(group),group1) & mask_male;
mask.group2 = fmask(meta_info_diff.(group),group2) & mask_male;
% return
