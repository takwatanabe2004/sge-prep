function model = tak_clf_L2loss_TV_ADMM_FFT_train(X, y, option)
%% model = tak_clf_L2loss_TV_ADMM_FFT_train(X, y, option)
%==============================================================================%
% Update 08/18/2015
% - removed "graphInfo" part; let tak_TV_regr_ADMM_FFT_over_relax compute
...
if option.over_relax
    model.w = tak_TV_regr_ADMM_FFT_over_relax(X,y,lam,gam,option);
else
