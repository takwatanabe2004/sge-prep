#! /bin/bash
#
# This script has been created to run the ./t_0807_runlibsvm_vol_TR_zscore.mcc 
...
#$ -o /cbica/home/watanabt/sge_job_output/t_0807_runlibsvm_vol_TR_zscore.mcc.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/watanabt/sge_job_output/t_0807_runlibsvm_vol_TR_zscore.mcc.$JOB_ID.stderr
####
#### My email address:
...
# file /cbica/home/watanabt/sge_job_output/t_0807_runlibsvm_vol_TR_zscore.mcc.$JOB_ID.stdout) and standard error (saved
# into the file /cbica/home/watanabt/sge_job_output/t_0807_runlibsvm_vol_TR_zscore.mcc.$JOB_ID.stderr) to make
# it easier to diagnose queued commands

/bin/echo "Command: ./t_0807_runlibsvm_vol_TR_zscore.mcc"
/bin/echo "Arguments: "
/bin/echo -e "Executing in: \c"; pwd
/bin/echo -e "Executing on: \c"; hostname
/bin/echo -e "Executing at: \c"; date
/bin/echo "----- STDOUT from ./t_0807_runlibsvm_vol_TR_zscore.mcc below this line -----"

/bin/echo "Command: ./t_0807_runlibsvm_vol_TR_zscore.mcc" 1>&2
...
/bin/echo "----- STDERR from ./t_0807_runlibsvm_vol_TR_zscore.mcc below this line -----" 1>&2

./t_0807_runlibsvm_vol_TR_zscore.mcc 
