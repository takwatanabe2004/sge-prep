#! /bin/bash
#
# This script has been created to run the ./enet_FAdiff_Risk_male_v12v06.mcc 
...
#$ -o /cbica/home/watanabt/sge_job_output/enet_FAdiff_Risk_male_v12v06.mcc.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/watanabt/sge_job_output/enet_FAdiff_Risk_male_v12v06.mcc.$JOB_ID.stderr
####
#### My email address:
...
# file /cbica/home/watanabt/sge_job_output/enet_FAdiff_Risk_male_v12v06.mcc.$JOB_ID.stdout) and standard error (saved
# into the file /cbica/home/watanabt/sge_job_output/enet_FAdiff_Risk_male_v12v06.mcc.$JOB_ID.stderr) to make
# it easier to diagnose queued commands

/bin/echo "Command: ./enet_FAdiff_Risk_male_v12v06.mcc"
/bin/echo "Arguments: "
/bin/echo -e "Executing in: \c"; pwd
/bin/echo -e "Executing on: \c"; hostname
/bin/echo -e "Executing at: \c"; date
/bin/echo "----- STDOUT from ./enet_FAdiff_Risk_male_v12v06.mcc below this line -----"

/bin/echo "Command: ./enet_FAdiff_Risk_male_v12v06.mcc" 1>&2
...
/bin/echo "----- STDERR from ./enet_FAdiff_Risk_male_v12v06.mcc below this line -----" 1>&2

./enet_FAdiff_Risk_male_v12v06.mcc 
