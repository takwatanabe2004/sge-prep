#! /bin/bash
#
# This script has been created to run the ./run_all_liblin_0807vol.mcc 
...
#$ -o /cbica/home/watanabt/sge_job_output/run_all_liblin_0807vol.mcc.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/home/watanabt/sge_job_output/run_all_liblin_0807vol.mcc.$JOB_ID.stderr
####
#### My email address:
...
# file /cbica/home/watanabt/sge_job_output/run_all_liblin_0807vol.mcc.$JOB_ID.stdout) and standard error (saved
# into the file /cbica/home/watanabt/sge_job_output/run_all_liblin_0807vol.mcc.$JOB_ID.stderr) to make
# it easier to diagnose queued commands

/bin/echo "Command: ./run_all_liblin_0807vol.mcc"
/bin/echo "Arguments: "
/bin/echo -e "Executing in: \c"; pwd
/bin/echo -e "Executing on: \c"; hostname
/bin/echo -e "Executing at: \c"; date
/bin/echo "----- STDOUT from ./run_all_liblin_0807vol.mcc below this line -----"

/bin/echo "Command: ./run_all_liblin_0807vol.mcc" 1>&2
...
/bin/echo "----- STDERR from ./run_all_liblin_0807vol.mcc below this line -----" 1>&2

./run_all_liblin_0807vol.mcc 
